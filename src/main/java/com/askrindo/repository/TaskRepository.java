...
public interface TaskRepository extends JpaRepository<Task, String> {
    ...
    @Query(nativeQuery = true, value = "select task_name, assigned_to, est_end_date from mst_task where est_end_date < now() and status_done like '%NOT STARTED%' order by est_end_date asc")
